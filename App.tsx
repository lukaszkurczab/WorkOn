...
import CreatePlanScreen from './src/screens/createPlanScreen/createPlanScreen';
        ...
        <NavigationContainer>
          ...
          <Navigation>
            <Stack.Navigator initialRouteName='MainScreen'>
              ...
              <Stack.Screen name='CreatePlanScreen' component={CreatePlanScreen} options={{ headerShown: false }} />
            </Stack.Navigator>
          </Navigation>
        </NavigationContainer>
      </PersistGate>
